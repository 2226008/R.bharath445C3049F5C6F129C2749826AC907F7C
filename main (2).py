class bankaccount:
  ...
  def deposit(self, amount):
    if amount > 0:
      ...
      print("deposit amount₹{}. account balance ₹{}".format(
  ...
  def display_balance(self):
    print(
        "Account balance .Account Name{}.Account Number{}. Account balance{}".
        format(self.__accountname, self.__accountno, self.__accountbalance))
